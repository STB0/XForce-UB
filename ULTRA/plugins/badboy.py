...
async def _(event):
    ...
    animation_chars = [
        ...
        "__INFO:XForce-UB: Logged in as 581993043__",
        "__INFO:XForce-UB: Successfully loaded all plugins__",
        "__INFO:XForce-UB: Successfully deployed Telegram v69.6.9 to Heroku__",
        "__INFO:XForce-UB: Processing the App__",
        "**Build Succeeded**",
    ]
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
